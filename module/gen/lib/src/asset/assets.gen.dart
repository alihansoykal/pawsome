...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/ic_policy.svg
  SvgGenImage get icPolicy => const SvgGenImage('assets/icons/ic_policy.svg');
  ...
  /// File path: assets/icons/ic_terms.svg
  SvgGenImage get icTerms => const SvgGenImage('assets/icons/ic_terms.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/img_splash_logo.png
  AssetGenImage get imgSplashLogo =>
      const AssetGenImage('assets/images/img_splash_logo.png');

  /// List of all assets
  List<AssetGenImage> get values => [imgSplashLogo];
}
